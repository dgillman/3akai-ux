define(["config/config"], function(config) {
    ...
    config.URL.TINY_MCE_CONTENT_CSS += ",/dev/skins/rsmart/skin.css,/dev/skins/rsmart/oipp.css";
    ...
    config.skinCSS = ["/dev/skins/default/skin.css", "/dev/skins/rsmart/skin.css", "/dev/skins/rsmart/oipp.css"];
    ...
    */
    ...
    config.Navigation.push({
        "url": "https://cole.uconline.edu/~help-and-support",
        "id": "help_tab1",
        "anonymous": true,
        "label": "HELP",
        "rightLink": true
